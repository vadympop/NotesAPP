...
<div>
  <v-row class="mt-6">
    ...
    <v-col cols="12" lg="6" md="8" class="pa-10 flex-column d-flex">
      <h1>HotesApp</h1>
      <p style="max-width: 60%">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias, commodi culpa distinctio et exercitationem mollitia nobis officia quidem, quo sed similique tempora unde vitae. Alias architecto nostrum numquam provident sapiente!</p>
    </v-col>
    <v-col cols="12" lg="4" md="3" sm="4" style="position:relative;">
      ...
      <div :class="{'info-block': true, 'blured': !isLoggedIn}">
        ...
        <div v-if="pages.length > 0" class="d-flex flex-column pages-list" style="flex: 1 1 0">
          <nuxt-link v-for="page of pages" :key="page._id" :to="`/${page._id}`" class="pages-list-item">
            <v-icon color="var(--light-gray3)" size="24px">mdi-file-document-outline</v-icon>
    ...
    <v-col cols="12" lg="4" md="3" sm="4" style="position:relative;">
      ...
      <div :class="{'info-block': true, 'blured': !isLoggedIn}">
        ...
        <div v-if="favouritePages.length > 0" class="d-flex flex-column pages-list">
          <nuxt-link v-for="page of favouritePages" :key="page._id" :to="`/${page._id}`" class="pages-list-item">
